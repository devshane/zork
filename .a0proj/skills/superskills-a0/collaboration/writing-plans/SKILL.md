...
**Save plans to:** `usr/projects/ai-game/docs/plans/YYYY-MM-DD-<feature-name>.md`
...
> **For Agent Zero:** Use `usr/projects/ai-game/.a0proj/skills/collaboration/executing-plans/SKILL.md` to implement this plan task-by-task.
